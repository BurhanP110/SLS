...
<div id="courses-wrapper">
    ...
    <div id="courses-list" class="grid grid-cols-3 sm:grid-cols-3 lg:grid-cols-3 gap-x-6 gap-y-16 lg:gap-16 mx-5 sm:mx-14 lg:mx-[7.5rem] mt-12 sm:mt-28">

        <!-- 8 Images with Lightbox -->
        <?php
        $images = [
        ...
        foreach ($images as $index => $img):
            ...
            <div class="courses-card">
                <button data-micromodal-trigger="<?= $modalId ?>">
                    <img src="<?= $imgPath ?>" alt="Gallery image <?= $index + 1 ?>" class="mx-auto w-[60%] rounded-xl hover:opacity-80 transition" />
                </button>
            </div>
        <?php endforeach; ?>
...
<!--             class="mt-16 lg:mt-40 mx-5 sm:mx-14 lg:mx-[7.5rem] flex flex-col sm:flex-row gap-4 sm:gap-6 lg:gap-12">-->
            ...
            <div class="w-full relative flex-1 border-8 border-white rounded-xl overflow-hidden">
                ...
                <iframe width="w-full" height="360" src="https://www.youtube.com/embed/v6ruwsd2hPc"
                        title="Ujwal Anil, German language expert, Director of Sprachenatelier, Mumbai" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                        referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
            </div>

            <!--Second video -->
            <div class="w-full relative flex-1 border-8 border-white rounded-xl overflow-hidden">
                <iframe width="w-full" height="360" src="https://www.youtube.com/embed/onnMaTwnLwc"
                        title="ASMU2" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                        referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
            ...
            <div class="w-full relative flex-1 border-8 border-white rounded-xl overflow-hidden">
                ...
                <iframe width="w-full" height="360" src="https://www.youtube.com/embed/DgBNZZnRCHk"
                        title="Aishwarya Deshpande" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                        referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
            </div>
