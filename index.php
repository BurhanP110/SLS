        ...
        <div class="flex flex-col gap-16 sm:gap-20">
          <div id="wuyc-1" class="flex flex-col-reverse sm:flex-row gap-8 sm:gap-20 justify-between items-center">
            <div>
              ...
              We follow a communication-first approach, focusing on reading, writing, listening, and speaking.

Every class is interactive, practical, and tailored to your goals.
              </p>
          ...
          <div id="wuyc-2" class="flex flex-col sm:flex-row gap-8 sm:gap-20 justify-between items-center">
            ...
            <div>
              ...
              <p class="text-sm md:text-base text-gray-600 mb-6">
                  Language is just the beginning—understanding culture completes the journey.
                  Our trainers bring insights from Germany to help students integrate seamlessly.
              </p>
              <div class="yellow-link w-max mt-4">
          ...
          <div id="wuyc-3" class="flex flex-col-reverse sm:flex-row gap-8 sm:gap-20 justify-between items-center">
            <div>
              ...
              <p class="text-sm md:text-base text-gray-600 mb-6">
                  Enthusiasm and interaction are at the heart of our teaching method.

                  We make German fun and immersive with practical lessons and active participation.
              </p>
              <div class="yellow-link w-max mt-4">
      ...
      <div id="metrics-section"
        ...
        <div class="flex flex-col gap-6 h-full">
          <div class="flex flex-col metric-box h-full">
            ...
            <span class="metric-number">198</span>
          ...
          <div class="flex sm:hidden flex-col metric-box h-full">
            ...
            <span class="metric-number">29.3k</span>
             <span class="metric-description">HI</span>
          </div>
          <div class="flex sm:hidden flex-col metric-box h-full">
        ...
        <div class="hidden sm:flex flex-col gap-6 h-full">
          ...
          <div class="flex flex-col metric-box h-full">
            <span class="metric-heading">Students Enrolled</span>
            <span class="metric-number">29.3k</span>
            <span class="metric-description">A growing community of 29k+ language enthusiasts and culture lovers.</span>
          </div>
          <div class="flex flex-col metric-box h-full">
            <span class="metric-number">20+</span>
            <span class="metric-heading">Public Universities Admitted To</span>
...
<!---->
<!--              <div class="ml-2">-->
<!--                  <img src="../assets/images/flagship_course.svg" alt="flagship badge" class="h-6 sm:h-8 w-auto" />-->
<!--              </div>-->
<!---->
<!--          </div>-->
<!--        </div>-->
        ...
        (Test auf Deutsch als Fremdsprache) : A mandatory examination for students, who are aspiring to study at Universities in all German-speaking countries. It teaches scientific terms across various fields.
                  ...
                  <div class="grid grid-cols-3 items-center mt-6">
                      ...
                      <div class="flex justify-end">
                          <img src="../assets/images/flagship_course.svg" alt="flagship badge" class="h-8 sm:h-7 w-auto" />
                      </div>
                  </div>
              </div>
          </div>
...
<!--        </div>-->
    ...
    <div id="testimonials-section" class="relative h-max w-screen mt-16 sm:mt-40">
      ...
      <div class="max-w-2xl mx-auto px-5 sm:px-9">
        <div class="glide">
          <div class="relative">
            <div class="glide__track testimonial-slide rounded-[20px] h-auto" data-glide-el="track">
              <ul id="testimonial-container" class="glide__slides">
              </ul>
            </div>
            <img src="../assets/images/double-quotes-close.svg" alt="" class="absolute -top-3 left-6 sm:-left-4" style="transform: rotate(180deg);"/>
    ...
    <div id="videos-section"
      ...
      <div class="w-full flex items-center justify-center mt-4">
          <a href="gallery_3.php">
          <button class="custom-yellow-outline-btn" data-text="Know More">
              <span>Know More</span>
          </button>
          </a>
      </div>
