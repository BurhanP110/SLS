...
<div>
    ...
    >
        ...
        <ul class="hidden lg:flex w-full gap-12 justify-end items-center">
            ...
            <li><a href="/gallery_3.php" class="<?php echo basename($_SERVER['PHP_SELF']) == 'gallery_3.php' ? 'font-semibold text-[#FE9F0F]' : ''; ?>">Gallery</a></li>
            <li>
...
>
  ...
  <li>
    ...
    <li>
        <a
                href="/gallery_3.php"
                class="<?php echo basename($_SERVER['PHP_SELF']) == 'gallery.php' ? 'font-semibold text-[#FE9F0F]' : ''; ?>"
        >
            Gallery
        </a>
    </li>
