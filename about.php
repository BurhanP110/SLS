  ...
  <div id="about-wrapper">
    ...
    <div id="metrics-section"
      ...
      <div
        ...
        <div class="flex flex-col items-start sm:items-center">
          <div class="metric-number" style="font-size: 1.8rem">12+</div>
          <div class="metric-heading tracking-wider" style="font-size: 0.9rem">
            YEARS OF EXPERIENCE
          </div>
        </div>
      ...
      <div
        ...
        <div class="flex flex-col items-start sm:items-center">
          <div class="metric-number" style="font-size: 1.8rem">198</div>
          <div class="metric-heading tracking-wider" style="font-size: 0.9rem">
            SUCCESS STORIES
          </div>
        </div>
      ...
      <div class="flex flex-col gap-6 max-lg:row-start-2">
        ...
        <div class="flex flex-col gap-4">
          ...
          <p class="text-base leading-[26px] text-[var(--gray-600)]">
              She heads the Sprachenatelier Language Studio (SALS), which prepares students and professionals not only for German language exams but also for cultural integration into German-speaking countries.

              <br><br>

              Trained by the TestDaF Institut Germany, Frau Ujwal has helped students consistently achieve meritorious results—most notably, several have emerged as global toppers with a perfect 20/20 score in the TestDaF examination.
              As an expert TestDaF Trainer, German Language Teacher for the IB Ab Initio programme (IBDP), and Telc language studies trainer, she believes that “Language is the gateway to global opportunities for students.
              ” With this philosophy, she actively promotes German language and culture through SALS and is now planning to further expand its reach to support even more aspiring learners across India and globally
          </p>
        </div>
      </div>
